...
/**
 * Border glow that tracks the cursor around a card — the "Cursor website" effect
 * from Aceternity (21st.dev). Adapted: framer-motion's `animate` (instead of
 * motion/react) and an indigo→violet→cyan gradient to match the site palette.
 */
